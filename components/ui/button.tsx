  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        // Special variants for Hijaiyah learning
        hijaiyah: "bg-emerald-500 text-white hover:bg-emerald-500/90 border-emerald-600 border-b-4 active:border-b-0",
        hijaiyahOutline: "bg-white text-emerald-600 border-emerald-300 border-2 hover:bg-emerald-50",
        story: "bg-amber-500 text-white hover:bg-amber-500/90 border-amber-600 border-b-4 active:border-b-0",
        storyOutline: "bg-white text-amber-600 border-amber-300 border-2 hover:bg-amber-50",
        hadith: "bg-purple-500 text-white hover:bg-purple-500/90 border-purple-600 border-b-4 active:border-b-0",
        hadithOutline: "bg-white text-purple-600 border-purple-300 border-2 hover:bg-purple-50",
      },
      size: {
